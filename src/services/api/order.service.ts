...
import { IOrderDocument, IExtendedDelivery, IDeliveredWork, IOrderMessage } from '@jahidhiron/jobber-shared';
...
class OrderService {
  constructor() {
    const axiosService = new AxiosService(`${process.env.ORDER_BASE_URL}/api/v1/order`, 'order');
